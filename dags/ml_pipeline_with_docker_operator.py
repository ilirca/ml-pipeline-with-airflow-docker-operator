...
"""
    ...
    model_train_and_publish_task = DockerOperator(
        ...
        environment={
            ...
            'MINIO_ACCESS_KEY_ID': 'w53yvcIN2mW6aA597uwc',
            'MINIO_SECRET_ACCESS_KEY': 'pgtwlVDdPRLK6Y6MhOtV7XmRXSMQ7NUR5xwcielC',
        ...
        command=['python', 'train_and_publish.py'],  # test ilir: it does same as in Dockerfile - trains and save pkl file
